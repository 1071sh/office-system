        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">プロジェクト一覧
                    @can('system-only')
                    <a class="btn btn-success" href="{{ route('project.create') }}" role="button">案件を登録する</a>
                    @endcan
                </div>
                <div class="card-body">
                    @if (session('success'))
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @can('system-only')
                                    <td class="text-nowrap"><a class="btn btn-outline-primary" href="{{ route('project.edit', $project->id) }}">編集</a></td>
                                    @endcan
                                </tr>
                                @endforeach
                            </tbody>
